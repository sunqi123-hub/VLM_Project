...
python blip2_test005.py \
    --model_path ./SaveFineTune/LDM-train-all-aligned-epochs00020/epoch010 \
...
# 定义目标保存目录（核心修改点1）
# ===========================
TARGET_SAVE_DIR = "./Test-Results/In_LDM_Results/sample500-all-aligned-010-In_LDM_Results"     # In_ADM_Results/In_ADM_Results/sample500-In_ADM_Results      all-In_LDM_Results
# 确保目标目录存在，不存在则创建
