...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_path', type=str, default='/root/autodl-tmp/project/VLM-DETECT-main/SaveFineTune',
                        help='Path to the trained model.')
    parser.add_argument('--dataset', default='/root/autodl-tmp/project/VLM-DETECT-main/data/test-adm.csv', type=str,
    ...
    model = Blip2ForConditionalGeneration.from_pretrained(config.base_model_name_or_path, load_in_8bit=True,
                                                          device_map="auto")
    model = PeftModel.from_pretrained(model, opt.model_path)
    processor = AutoProcessor.from_pretrained("/root/autodl-tmp/project/VLM-DETECT-main/blip2-opt-2.7b")
...
#python blip2_test-0.py --model_path  root/autodl-tmp/project/VLM-DETECT-main/weights/admFineTune  --dataset  root/autodl-tmp/project/VLM-DETECT-main/data/Test_CSV/test_ADM.csv
