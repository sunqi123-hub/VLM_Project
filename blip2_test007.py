...
python blip2_test005.py \
    --model_path ./weights/iddpmFineTune \
...
#自己训练--model_path    ./SaveFineTune/LDM-train-epochs3
改63行
和6的基础上运行时去掉字体提示
...
# 定义目标保存目录（核心修改点1）
# ===========================
TARGET_SAVE_DIR = "./Test-Results/In_LDM_Results/sample200-In_LDM_Results"     # In_ADM_Results/In_ADM_Results/sample500-In_ADM_Results      all-In_LDM_Results
# 确保目标目录存在，不存在则创建
...
python blip2_test007.py \
    --model_path ./weights/ldmFineTune \
    --dataset ./data/Test_CSV/test_LDM.csv \
              ./data/Test_CSV/test_ADM.csv \
              ./data/Test_CSV/test_DDPM.csv \
              ./data/Test_CSV/test_IDDPM.csv \
...
测试完整测试集
python blip2_test007.py \
    --model_path ./weights/ddpmFineTune \
    --dataset ./data/Test_CSV/test_DDPM.csv

#随机抽取100张测试
python blip2_test007.py \
    --model_path ./weights/admFineTune \
    --dataset ./data/Test_CSV/test_ADM.csv \
    --num_samples 100
"""
