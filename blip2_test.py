...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_path', type=str, default='./SaveFineTune',
                        help='Path to the trained model.')
    parser.add_argument('--dataset', default='./data/test-adm.csv', type=str,
    ...
    local_model_path = "./blip2-opt-2.7b"      # 修改为本地模型路径
...
# python blip2_test.py     --model_path ./weights/admFineTune   --dataset ./data/test-adm.csv
